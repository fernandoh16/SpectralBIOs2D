...
int main(int argc, char* argv[]) {
    ...
    gMLQMC::samplers::Halton<double> Halton_Sampler(NumberOfParameters) ;
	auto Out = gMLQMC::SLQMC<gMLQMC::strategy::full>(Integrand,Halton_Sampler,Me,Level,world.size()) ;
